...
export function LinkedInTab({ liPosts, liStats, onSelectContent }: LinkedInTabProps) {
  ...
  return (
    <div className="space-y-8">
      {/* Stats overview */}
      <div className="rounded-xl px-5 py-4 flex items-center gap-6" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      {dailySeries.length > 1 && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="rounded-xl p-5" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      <div>
        ...
        {liPosts.length === 0 ? (
          ...
          <div className="rounded-xl divide-y divide-white/[0.04]" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
