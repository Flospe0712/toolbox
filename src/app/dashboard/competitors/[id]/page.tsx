...
export default function CompetitorDetailPage() {
  ...
  return (
    <div className="min-h-screen p-8 max-w-4xl mx-auto" style={{ background: '#0d0d0d' }}>
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {competitor.socials.map(social => {
              ...
              return (
                <div key={social.id} className="rounded-xl p-4" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      <div className="mb-10">
        ...
        {bioAlerts.length === 0 ? (
          <div className="rounded-xl p-6 text-center" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div className="space-y-3">
            {bioAlerts.map(alert => {
              ...
              return (
                <div key={alert.id} className="rounded-xl p-4" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        {posts.length === 0 ? (
          ...
          <div className="space-y-3">
            {posts.map(post => {
              ...
              return (
                <div key={post.id} className="rounded-xl p-4 flex gap-4" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
                  {post.thumbnail_url && (
                    <img src={post.thumbnail_url} alt="" className="w-28 h-20 rounded-lg object-cover flex-shrink-0" style={{ background: '#0a0a0a' }} />
                  )}
      ...
      {competitor.business_notes && Object.keys(competitor.business_notes).length > 0 && (
        <div className="mb-10">
          ...
          <div className="rounded-xl p-4" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      {(competitor.content_style || competitor.notable) && (
        <div className="mb-10">
          ...
          <div className="rounded-xl p-4 space-y-4" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
