...
export default function CompetitorsPage() {
  ...
  return (
    <div className="min-h-screen p-8" style={{ background: '#0d0d0d' }}>
      ...
      {/* Alerts banner */}
      {alerts.length > 0 && (
        <div className="mb-6 rounded-xl" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
          <button
      ...
      {loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-44 rounded-xl animate-pulse" style={{ background: '#111' }} />
          ))}
        </div>
        ...
        /* Table view */
        <div className="rounded-xl overflow-hidden" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
