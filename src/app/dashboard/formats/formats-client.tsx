...
function AddFormatModal({ onClose, onAdded }: { onClose: () => void; onAdded: (f: Format) => void }) {
  ...
  return (
    ...
    >
      <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 28, width: '100%', maxWidth: 520 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div>
            ...
            <input
              ...
              style={{ width: '100%', marginTop: 6, background: '#0d0d0d', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, padding: '9px 12px', fontSize: 13, color: 'white', outline: 'none', boxSizing: 'border-box' }}
            />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            <div>
              ...
              <select
                ...
                style={{ width: '100%', marginTop: 6, background: '#0d0d0d', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, padding: '9px 12px', fontSize: 13, color: 'white', outline: 'none' }}
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              style={{ width: '100%', marginTop: 6, background: '#0d0d0d', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, padding: '9px 12px', fontSize: 13, color: 'white', outline: 'none', resize: 'none', boxSizing: 'border-box' }}
            />
          </div>
...
function ApplyModal({ format, onClose }: { format: Format; onClose: () => void }) {
  ...
  return (
    <div
      ...
      onClick={e => e.target === e.currentTarget && onClose()}
    >
      <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 28, width: '100%', maxWidth: 480 }}>
        {done ? (
          ...
          <>
            ...
            <input
              ...
              style={{ width: '100%', background: '#0d0d0d', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, padding: '9px 12px', fontSize: 13, color: 'white', outline: 'none', boxSizing: 'border-box', marginBottom: 16 }}
            />
...
export function FormatsClient({ formats: initialFormats }: { formats: Format[] }) {
  ...
  return (
    <div className="p-8 space-y-6" style={{ background: '#0d0d0d', minHeight: '100vh' }}>
      ...
      {formats.length === 0 && (
        <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 14, padding: '28px 32px', maxWidth: 580 }}>
