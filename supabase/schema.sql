...
CREATE POLICY "Authenticated users manage ideas"
...
CREATE POLICY "Authenticated users manage idea_platforms"
  ON idea_platforms FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Authenticated users manage idea_tags"
  ON idea_tags FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Authenticated users manage idea_tag_links"
  ON idea_tag_links FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
ALTER TABLE idea_relations ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Authenticated users manage idea_relations"
  ON idea_relations FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
ALTER TABLE supporting_media ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Authenticated users manage supporting_media"
  ON supporting_media FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Authenticated users can manage video_transcriptions"
  ON video_transcriptions FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated" ON video_attachments
...
CREATE POLICY "Authenticated users manage thumbnails"
  ON thumbnails FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Authenticated users manage video_thumbnails"
  ON video_thumbnails FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
ALTER TABLE video_ab_variants ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Authenticated users manage video_ab_variants"
  ON video_ab_variants FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on video_ab_variants"
  ON video_ab_variants FOR ALL TO service_role USING (true) WITH CHECK (true);
...
ALTER TABLE social_media_files ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Authenticated users can manage social_media_files"
  ON social_media_files FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "auth_select_blog_posts" ON blog_posts FOR SELECT USING (auth.role() = 'authenticated');
CREATE POLICY "auth_insert_blog_posts" ON blog_posts FOR INSERT WITH CHECK (auth.role() = 'authenticated');
CREATE POLICY "auth_update_blog_posts" ON blog_posts FOR UPDATE USING (auth.role() = 'authenticated');
CREATE POLICY "auth_delete_blog_posts" ON blog_posts FOR DELETE USING (auth.role() = 'authenticated');
...
CREATE POLICY "auth_select_content_sources" ON content_sources FOR SELECT USING (auth.role() = 'authenticated');
CREATE POLICY "auth_insert_content_sources" ON content_sources FOR INSERT WITH CHECK (auth.role() = 'authenticated');
CREATE POLICY "auth_update_content_sources" ON content_sources FOR UPDATE USING (auth.role() = 'authenticated');
CREATE POLICY "auth_delete_content_sources" ON content_sources FOR DELETE USING (auth.role() = 'authenticated');
...
CREATE POLICY "Allow all for service role" ON content_preferences FOR ALL USING (true);
...
ALTER TABLE competitor_social_snapshots ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Allow all for anon" ON competitor_socials FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for anon" ON competitor_social_snapshots FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for anon" ON competitor_posts FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for anon" ON competitor_alerts FOR ALL USING (true) WITH CHECK (true);
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname = 'storage' AND tablename = 'objects' AND policyname = 'Public thumbnail reads'
  ) THEN
    CREATE POLICY "Public thumbnail reads" ON storage.objects
      FOR SELECT USING (bucket_id = 'thumbnails');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname = 'storage' AND tablename = 'objects' AND policyname = 'Allow thumbnail uploads'
  ) THEN
...
CREATE POLICY "Allow upload profile-pictures" ON storage.objects
  FOR INSERT WITH CHECK (bucket_id = 'profile-pictures');

CREATE POLICY "Allow delete profile-pictures" ON storage.objects
...
BEGIN
  ...
  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE thumbnails; EXCEPTION WHEN duplicate_object THEN NULL; END;
  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE assets; EXCEPTION WHEN duplicate_object THEN NULL; END;
  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE videos; EXCEPTION WHEN duplicate_object THEN NULL; END;
  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE blog_posts; EXCEPTION WHEN duplicate_object THEN NULL; END;
END $$;
