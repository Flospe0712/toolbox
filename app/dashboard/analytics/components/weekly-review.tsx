    ...
    <section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        {platforms.map(({ key, label, icon: Icon, iconBg, color, data: pd, reachLabel }) => {
          ...
          return (
            <div key={key} className="rounded-xl overflow-hidden" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      {ytStats && (
        <div className="mt-4 rounded-xl px-4 py-3 flex items-center gap-3" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.05)' }}>
