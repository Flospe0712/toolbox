    ...
    <div>
      ...
      {open && (
        <div className="mt-2 space-y-2">
          ...
          {/* Result */}
          {result && !uploading && (
            <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.07)', background: '#0a0a0a' }}>
              {/* Tabs */}
              <div className="flex items-center gap-1 px-3 py-2" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)', background: '#0d0d0d' }}>
