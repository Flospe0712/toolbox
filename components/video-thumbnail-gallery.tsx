    ...
    <div className="space-y-4">
      ...
      {chosen ? (
        ...
        <div
          ...
          style={{ border: '1px dashed rgba(255,255,255,0.08)', background: '#0a0a0a' }}
        >
      ...
      {others.length > 0 && (
        <div className="space-y-1.5">
          ...
          <div className="flex gap-2 flex-wrap">
            {others.map(vt => (
              <div key={vt.id} className="group relative w-32 rounded-lg overflow-hidden aspect-video" style={{ background: '#0a0a0a' }}>
      ...
      {/* Searchable gallery */}
      {galleryOpen && (
        <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.06)', background: '#0d0d0d' }}>
            ...
            {allThumbs.length === 0 ? (
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
                {filteredGallery.map(thumb => {
                  ...
                  return (
                    <div key={thumb.id} className="group relative rounded-lg overflow-hidden aspect-video" style={{ background: '#111' }}>
                      {src ? (
