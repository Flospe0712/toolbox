...
function LinkedInCarousel({ images }: { images: { url: string | null; filename: string }[] }) {
  ...
  return (
    <div className="relative w-full" style={{ aspectRatio: '1/1', background: '#0a0a0a' }}>
      {images[idx]?.url ? (
...
export function ContentDetailModal({ item, onClose }: ContentDetailModalProps) {
  ...
  if (item.platform === 'linkedin') {
    ...
    // Tweet preview card
    leftPanel = (
      <div className="flex-shrink-0 flex items-center justify-center" style={{ width: 440, background: '#0a0a0a' }}>
    ...
    leftPanel = (
      <div className="flex-shrink-0 bg-black flex items-center justify-center p-4" style={{ width: 480 }}>
        <div className="w-full rounded-2xl overflow-hidden" style={{ aspectRatio: '16/9', background: '#0a0a0a' }}>
          {item.data.thumbnail ? (
    ...
    leftPanel = (
      <div className="flex-shrink-0 bg-black flex items-center justify-center p-4">
        <div className="w-[340px] rounded-2xl overflow-hidden" style={{ aspectRatio: '9/16', background: '#0a0a0a' }}>
          {imageUrl ? (
    ...
    leftPanel = (
      <div className="flex-shrink-0 bg-black flex items-center justify-center p-4">
        <div className="w-[420px] rounded-2xl overflow-hidden" style={{ aspectRatio: '1/1', background: '#0a0a0a' }}>
