...
export function PdfCarousel({ url, filename }: PdfCarouselProps) {
  ...
  if (loading) {
    return (
      <div className="w-full flex items-center justify-center py-20" style={{ background: '#0a0a0a' }}>
  ...
  if (error) {
    return (
      <div className="w-full flex items-center justify-center py-12" style={{ background: '#0a0a0a' }}>
